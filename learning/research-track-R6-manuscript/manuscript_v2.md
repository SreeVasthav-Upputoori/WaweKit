...
division of work. Contribution statements are assertions about who did what and
must be written by the authors themselves, not inferred.*
...
*To be completed. State any grant numbers, or declare that the work received no
specific funding.*

## Competing interests

*To be completed. Declare any competing interests, or state that the authors
declare none.*

## Declaration of generative AI use

*To be completed by the authors. Journals increasingly require disclosure of
generative-AI assistance in preparing a manuscript or its accompanying
software; check the target journal's current policy and describe the nature and
